            ...
            {channelType === 'email' && (
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input value={emailSmtpHost} onChange={e => setEmailSmtpHost(e.target.value)} className={INPUT} placeholder="server13.serverdrift.com" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input value={emailSmtpUser} onChange={e => setEmailSmtpUser(e.target.value)} className={INPUT} placeholder="info@hedburgaren.se" />
                </div>
                <div>

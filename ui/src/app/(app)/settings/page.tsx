        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              // (Inkrementella backuper flyttad — finns nu via restic-executor; skapa ett restic-jobb under "Backupjobb".)
              // (Disaster Recovery-plan flyttad — runbook + kvartalsdrill finns nu i docs/disaster-recovery.md, schemalagd via routine.)

      ...
      {showForm && (
        <div className="bg-vm-surface border border-vm-border-bright rounded p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
              <FormLabel label="Project / Domain" tooltip="Group backups by project or domain name. Useful for filtering and organizing artifacts. Example: 'example.com', 'myapp-prod'." />

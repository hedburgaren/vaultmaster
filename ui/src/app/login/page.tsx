    ...
    <div className="min-h-screen flex items-center justify-center relative z-[1]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <div className="font-mono text-xs text-vm-accent tracking-[3px] mt-1">{t('login.subtitle')}</div>
        </div>
        ...
        <form onSubmit={handleLogin} className="bg-vm-surface border border-vm-border rounded-lg p-8">
          ...
          <div className="mb-5">
            <label className="block font-mono text-[11px] text-vm-text-dim tracking-[2px] uppercase mb-2">{t('login.username')}</label>
          ...
          <div className="mb-6">
            <label className="block font-mono text-[11px] text-vm-text-dim tracking-[2px] uppercase mb-2">{t('login.password')}</label>

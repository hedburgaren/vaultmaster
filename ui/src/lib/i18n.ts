...
const translations: Dict = {
  ...
  'servers.db_host_tip': { sv: 'Databasserverns adress sett från servern. Vanligtvis 127.0.0.1 om databasen körs lokalt.', en: 'Database server address as seen from the server. Usually 127.0.0.1 if the database runs locally.' },
  ...
  'servers.db_password_tip': { sv: 'Lösenord för databasanvändaren. Krypteras innan lagring.', en: 'Password for the database user. Will be encrypted before storage.' },
  'servers.db_password_placeholder': { sv: 'Ange databaslösenord', en: 'Enter database password' },
